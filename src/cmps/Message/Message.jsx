...
export default class Message extends Component {
  ...
  render() {
    const {uuid, rating = 0, approved, title, text = '', authorUuid, comments, tags, published} = this.props;

    return (
      <article className={bem.mix('media')} id={`question-${uuid}`}>
          ...
          <div className={bem.elem('left')}>
            ...
            <div className={bem.elem('author')}>
              ...
              <div className={bem.elem('author-details')}>
                ...
                <div className={bem.elem('author-time')}>asked&nbsp;{new Date(published).toLocaleString()}</div>
              </div>
            </div>
          </div>
        </div>
